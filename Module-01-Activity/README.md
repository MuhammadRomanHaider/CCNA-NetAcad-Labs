...
![Logical View](Lab_workspace.png (2).png)

#### 2. Geographic Network Overview (City-to-City Submarine Cable)
![Geographic Map](Lab_workspace.png (6).png)

#### 3. Branch Office Wiring Closet (Physical Mode Installation)
![Branch Office Physical Layout](Lab_workspace.png)

#### 4. Hostname Configuration via Device Terminal
![Terminal Configuration](Lab_workspace.png (3).png)

#### 5. Warrenton Data Center Server Racks
![Data Center Racks](Lab_workspace.png (4).png)

#### 6. Final Assessment Verification (100% Correct)
![Assessment Results](Lab_workspace.png (5).png)
